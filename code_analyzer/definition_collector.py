...
class BaseInfoCollector:
    def __init__(self, func_names: Set[str],
        ...
        self.macro_func_args: Dict[str, List[str]] = global_visitor.macro_func_args
        self.macro_func_bodies: Dict[str, str] = global_visitor.macro_func_bodies
    ...
    def build_basic_info(self):
        ...
        for func_key in tqdm(self.considered_funcs, desc="building busic parameter infos", ncols=100):
    ...
    def build_ori_param_types_4_funcs(self):
        for func_key, func_info in tqdm(self.func_info_dict.items(), desc="building original parameter infos", ncols=100):
            types = []
            ori_types = []
